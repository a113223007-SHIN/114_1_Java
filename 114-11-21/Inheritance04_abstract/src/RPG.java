public class RPG {
    public static void main(String[] args) {
        ...
        magician_dark.showSpecialSkill();
        magician_light.showSpecialSkill();
        swordsMan_dark.showSpecialSkill();
        swordsMan_light.showSpecialSkill();
        shieldSwordsMan.showSpecialSkill();
