...
//        printCustomerAccounts(customers);
            ...
            switch (choice) {
                ...
                case 5://存款
                    ...
                    try {
                        ...
                        System.out.println("存款成功，帳戶 " + depAccount.getAccountNumber() + " 新餘額: " + String.format("%.2f", depAccount.getBalance()));
                ...
                case 6: // 提款
                    ...
                    String wdrAccNum = scanner.nextLine();
                    Account wdrAccount = customerInAction(customers, wdrAccNum);
                    if (wdrAccount == null) break;
                    System.out.print("輸入提款金額: ");
                    double wdrAmount = scanner.nextDouble();
                    scanner.nextLine();
                    try {
                        wdrAccount.withdraw(wdrAmount);
                        System.out.println("提款成功，帳戶 " + wdrAccount.getAccountNumber() + " 新餘額: " + String.format("%.2f", wdrAccount.getBalance()));
                    } catch (IllegalArgumentException e) {
    ...
    // 功能選單 (1) 新增客戶 (2) 列印指定客戶帳戶資訊 (3) 顯示所有客戶帳戶資訊 (4) 刪除客戶帳戶 (5) 離開 (6) 存款 (7) 提款
